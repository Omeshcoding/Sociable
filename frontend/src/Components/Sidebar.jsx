...
const Sidebar = ({ setUser }) => {
  ...
  return (
    <nav className="flex flex-col lg:h-[100%] w-[100%] lg:w-[20%] px-3 md:px-10 capitalize justify-center fixed bottom-0 lg:top-0 bg-slate-100/95 shadow-xl py-4 gap-10 md:gap-16 lg:gap-20 ">
